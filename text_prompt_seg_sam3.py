...
def main() -> None:
    ...
    for obj_name in sorted(obj_names):
        ...
        overrides = {
            ...
            "cat": "An orange and white cat.",
            "cat2": "cat",
            "cat_statue": "cat statue figurine.",
            "chair": "chair",
            "clock": "A copper alarm clock with a crown on the face.",
            "colorful_sneaker": "adidas sneakers court vantage w - large",
            ...
            "dog3": "A small white dog.",
            "dog4": "dog",
            "dog5": "A brown and white dog with its tongue sticking out.",
            "dog6": "A brown dog with a black collar.",
            "dog7": "A white and black dog.",
            "dog8": "dog",
            "duck_toy": "duck toy",
            "elephant": "elephant",
            "fancy_boot": "fancy fashion boot",
            "grey_sloth_plushie": "grey sloth plushie",
            "monster_toy": "A red stuffed monster toy with a yellow ball in its mouth.",
            ...
            "teapot": "teapot",
            "teddybear": "A brown teddy bear.",
            "thin_bird": "A thin white bird's figurine.",
            "tortoise_plushy": "A green turtle stuffed plushie animal with big eyes.",
        ...
        overrides = {
            ...
            "red_cartoon": "red cartoon",
            "robot_toy": "robot toy",
            "round_bird": "round bird",
            "shiny_sneaker": "shiny sneaker",
            "table": "table",
            "teapot": "teapot",
